...
const Update = () => {
    ...
    <nav class="nav nav-borders">
        <Link class="nav-link active ms-0" to="#" target="__blank">Personal</Link>
        <Link class="nav-link" to="#" target="__blank">Experience</Link>
        <Link class="nav-link" to="#" target="__blank">Education</Link>
        <Link class="nav-link" to="#"  target="__blank">Extra</Link>
    </nav>
    <hr class="mt-0 mb-4"/>
    <div class="row">
        <div class="col-xl-4">
            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body text-center">
                    ...
                    <img class="img-account-profile rounded-circle mb-2 w-75" src="./profile.jpg" alt=""/>
